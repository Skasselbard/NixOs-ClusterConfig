            ...
            example = {
              ...
              services = {
                ...
                vault = {
                  ...
                  # Cluster-level vault options (enableUi, logLevel, certificates, …)
                  enableUi = true;
              ...
              machines =
                let
                  ...
                  # We deploy them with a function that takes a machine's NixOS config
                  # and derives the deployment keys (as used by colmena or nixops).
                  vaultKeys =
                    machineConfig:
                    let
