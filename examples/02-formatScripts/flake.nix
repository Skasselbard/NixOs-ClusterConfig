              ...
              machines = {
                ...
                vm0 = {
                  ...
                  deployment = {
                    ...
                    # If the deployment.format attribute is null (or unset)
                ...
                vm1 = {
                  ...
                  deployment = {
                    ...
                    # If the deployment.format attribute is set to "disko"
                    ...
                    # See the disko documentation on how to define the disko attribute:
                ...
                vm2 = {
                  ...
                  deployment = {
                    ...
                    # This can come in handy if you want to use part of your disko configuration
                    ...
                    # and only use the ephemeral config for formatting.
